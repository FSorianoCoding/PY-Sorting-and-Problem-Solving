...
# Note that a key parameter will need to be used here in order for the sorting to be case-insensitive 
# (sort in alphabetical order regardless of whether string is uppercase or lowercase).
